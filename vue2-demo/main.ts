...
new Vue({
  ...
  data() {
    return {
      ...
      lastEvent: '',
      toolbarItems: ['find', 'filter', 'sort', 'clear-filter', 'separator', 'copy', 'format-painter', 'pivot-table', 'conditional-format', 'number-format', 'wrap-text', 'image-tools', 'freeze', 'separator', 'template', 'separator', 'zoom', 'export'],
